    ...
    def __init__(
        ...
        if self.is_deepspeed_enabled:
            ...
            self.ref_policy = prepare_deepspeed(
                self.ref_policy, args.per_device_train_batch_size, fp16=False, bf16=True 
            )
        else:
            if self.reward_model is not None:
                    ...
                    for micro_batch_start in tqdm.tqdm(range(0, args.local_mini_batch_size, args.per_device_train_batch_size)):
                        ...
                        with accelerator.accumulate(model):
                            ...
                            with torch.no_grad():
                                ...
                                approxkl = kl.mean()
                                approxkl_stats[ppo_epoch_idx, minibatch_idx, gradient_accumulation_idx] = approxkl/all_response_lens[0]
                                pg_loss_stats[ppo_epoch_idx, minibatch_idx, gradient_accumulation_idx] = pg_loss/all_response_lens[0]
